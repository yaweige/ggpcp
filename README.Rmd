...
[![Travis-CI Build Status](https://travis-ci.org/heike/gglogo.svg?branch=master)](https://travis-ci.org/yaweige/ggpcp)
...
```{r echo = FALSE, warning=FALSE}
gather_data <- gather_pcp(original_data, columns = 1:7)

#compute_panel = function(data, scales, freespace = 0.1)
final_data <- compute_panel(gather_data, scales = NULL, freespace = 0.1)
...
nobs <- 100
# detect the factor
classpcp <- c("factor", "factor", "numeric", "factor", 
